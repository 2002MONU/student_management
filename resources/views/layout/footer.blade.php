<footer class="footer">
          <div class="footer-body gap-2">
              ...
              <div class="right-panel text-center">
                  ©<script>document.write(new Date().getFullYear())</script> One Way Taxi , Made with
                  ...
                  </span> by <a href="#" target="_blank">The Colour Moon </a>.
              </div>
          </div>
      </footer>   
     </main>
    ...
    <!-- Mapchart JavaScript -->
    <script src="{{url('assets/js/charts/vector-chart.js')}}"></script>
    <script src="{{url('assets/js/charts/dashboard.js')}}"></script>
    
    <!-- app JavaScript -->
    <script src="{{url('assets/js/coinex.js')}}"></script>
    
    <!-- apexchart JavaScript -->
    <script src="{{url('assets/js/charts/apexcharts.js')}}"></script>
    
    <!-- Gsap Animation Init -->
    <script src="{{url('assets/js/gsap.js')}}"></script>  </body>
